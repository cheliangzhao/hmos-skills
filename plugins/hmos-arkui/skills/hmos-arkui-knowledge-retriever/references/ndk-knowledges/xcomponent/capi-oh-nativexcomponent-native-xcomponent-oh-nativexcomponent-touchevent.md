...
| [OH_NativeXComponent_TouchPoint](capi-oh-nativexcomponent-native-xcomponent-oh-nativexcomponent-touchpoint.md) touchPoints[[OH_NATIVE_XCOMPONENT_MAX_TOUCH_POINTS_NUMBER]](capi-native-interface-xcomponent-h.md#变量) | 当前触摸点的数组。 |
