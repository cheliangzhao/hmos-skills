...
| 需求场景 | 推荐方法 | 说明 |
|------|---------|------|
| 固定行列网格，部分项占多行多列 | [OH_ArkUI_GridLayoutOptions_RegisterGetRectByIndexCallback](../reference/apis-arkui/capi-native-type-h.md#oh_arkui_gridlayoutoptions_registergetrectbyindexcallback) | 灵活控制每个项的位置和大小。 |
