...
> 2. **编码中**：写属性和参数时对照第 7 节（属性参数使用错误），根据功能类型对照其他章节（状态管理看第 3-5 节，列表渲染看第 6 节，导航看第 8 节，@Builder 复用看第 12 节，状态不刷新看第 13 节）
...
| [12-builder-params.md](common-mistakes/12-builder-params.md) | 第12节 | @Builder 参数传递错误（不刷新/参数不对等） | 编码中 |
| [13-observed-no-refresh.md](common-mistakes/13-observed-no-refresh.md) | 第13节 | @Observed/@ObjectLink 不刷新问题 | 编码中 |
